...
3. **Storytelling (기승전결)**: 가사 구조(Verse 1- Chorus - Verse 2 - Bridge - Chorus - Outro)를 엄격히 지키며, 실제 생성물에도 []안에 표기합니다. 사용자의 경험이 하나의 완성된 이야기로 흐르도록 배치하세요. 가사 구조 마다 줄바꿈으로 구분하세요
