...
2. **Literary Expansion**: 사용자의 짧은 답변을 그대로 쓰지 마세요. 당시의 계절감, 온도, 공기의 냄새, 시각적 이미지를 동원하여 문학적으로 확장하세요. 또한 사용자가 선택한 희망 장르와 희망 분위기를 고려한 가사를 작성하세요.
3. **Storytelling (기승전결)**: 가사 구조(Intro - Verse 1- Pre-Chorus- Chorus - Interlude(간주, 가사없음) - Verse 2 - Bridge - Chorus - Outro)를 엄격히 지키며, 실제 생성물에도 []안에 표기합니다. 사용자의 경험이 하나의 완성된 이야기로 흐르도록 배치하세요.
가사 한 줄 마다 줄바꿈 표시를 \n로 해주세요.
